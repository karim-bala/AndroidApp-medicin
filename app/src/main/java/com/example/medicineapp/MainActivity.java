...
//        medicineViewModel.getAll().observe(this, new Observer<List<Medicine>>() {
//            @Override
//            public void onChanged(List<Medicine> medicines) {
//                customAdapter.setMedicinesList(medicines);
//            }
//        });
//
//    }
    ...
    void storeDataInArrays(){
        ...
        if(cursor.getCount() == 0){
            ...
            while (cursor.moveToNext()){
                ...
                book_pages.add(cursor.getString(13));
                Log.d("stev", String.valueOf(cursor.getString(0)));
            }
